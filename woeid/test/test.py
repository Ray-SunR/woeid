...
class WoeidUnitTests(unittest.TestCase):
	...
	def test_all(self):
		...
		print("self.__api.GetPlaces(q=u'福州') %s", 'pass')
		...
		self.assertEqual(woeid.GetLastResponseCode(), 200)
		print("self.__api.GetPlaces(q=u'中国') %s", 'pass')
		...
		self.assertEqual(woeid.GetLastResponseCode(), 200)
		print("self.__api.GetPlaces(q='Long Island', typ=22, nd=True) %s", 'pass')
		...
		self.assertEqual(woeid.GetLastResponseCode(), 200)
		print("self.__api.GetPlaces(woeid=[2488042, 2488836, 2486340]) %s", 'pass')
		...
		self.assertEqual(woeid.GetLastResponseCode(), 200)
		print("self.__api.GetPlace(woeid=2507854) %s", 'pass')
		...
		self.assertEqual(woeid.GetLastResponseCode(), 200)
		print("self.__api.GetPlace(woeid=12521721) %s", 'pass')
		...
		self.assertEqual(woeid.GetLastResponseCode(), 200)
		print("self.__api.GetPlace(woeid=638242, parent=True) %s", 'pass')
		...
		self.assertEqual(woeid.GetLastResponseCode(), 200)
		print("self.__api.GetPlace(woeid=12587712, ancestors=True) %s", 'pass')
		...
		self.assertEqual(woeid.GetLastResponseCode(), 200)
		print("self.__api.GetPlace(woeid=23424900, belongtos=True) %s", 'pass')
		...
		self.assertEqual(woeid.GetLastResponseCode(), 200)
		print("self.__api.GetPlace(woeid=2347563, neighbors=True) %s", 'pass')
		...
		self.assertEqual(woeid.GetLastResponseCode(), 200)
		print("self.__api.GetPlace(woeid=2347563, neighbors=True, degree=2) %s", 'pass')
		...
		self.assertEqual(woeid.GetLastResponseCode(), 200)
		print("self.__api.GetPlace(woeid=2347563, siblings=True) %s", 'pass')
		...
		self.assertEqual(woeid.GetLastResponseCode(), 200)
		print("self.__api.GetPlace(woeid=23424977, children=True) %s", 'pass')
		...
		self.assertEqual(woeid.GetLastResponseCode(), 200)
		print("self.__api.GetPlace(woeid=2488042, children=True, degree=2) %s", 'pass')
		...
		self.assertEqual(woeid.GetLastResponseCode(), 200)
		print("self.__api.GetPlace(woeid=2507854, descendants=True) %s", 'pass')
		...
		self.assertEqual(woeid.GetLastResponseCode(), 200)
		print("self.__api.GetPlace(woeid=(2507854, 2380824), common=True) %s", 'pass')
		...
		self.assertEqual(woeid.GetLastResponseCode(), 200)
		print("self.__api.GetPlace(woeid=(2488042, 2488836, 2486340), common=True) %s", 'pass')
		...
		self.assertEqual(woeid.GetLastResponseCode(), 200)
		print("self.__api.GetContinents() %s", 'pass')
		...
		self.assertEqual(woeid.GetLastResponseCode(), 200)
		print("self.__api.GetOceans() %s", 'pass')
		...
		self.assertEqual(woeid.GetLastResponseCode(), 200)
		print("self.__api.GetSeas() %s", 'pass')
		...
		self.assertEqual(woeid.GetLastResponseCode(), 200)
		print("self.__api.GetSeas(place='Pacific Ocean') %s", 'pass')
		...
		self.assertEqual(woeid.GetLastResponseCode(), 200)
		print("self.__api.GetCountries() %s", 'pass')
		...
		self.assertEqual(woeid.GetLastResponseCode(), 200)
		print("self.__api.GetCountries(place='NA') %s", 'pass')
		...
		self.assertEqual(woeid.GetLastResponseCode(), 200)
		print("self.__api.GetStates(country='US') %s", 'pass')
		...
		self.assertEqual(woeid.GetLastResponseCode(), 200)
		print("self.__api.GetCounties(state='CA') %s", 'pass')
		...
		self.assertEqual(woeid.GetLastResponseCode(), 200)
		print("self.__api.GetDistricts(county='Greater London') %s", 'pass')
		...
		self.assertEqual(woeid.GetLastResponseCode(), 200)
		print("self.__api.GetConcordance(namespace='iso', id='CA-BC') %s", 'pass')
		...
		self.assertEqual(woeid.GetLastResponseCode(), 200)
		print("self.__api.GetPlacetypes() %s", 'pass')
		...
		self.assertEqual(woeid.GetLastResponseCode(), 200)
		print("self.__api.GetPlacetypes(typ=[0,2,22,37,38,15,16]) %s", 'pass')
		...
		self.assertEqual(woeid.GetLastResponseCode(), 200)
		print("self.__api.GetPlacetypes(country='ES') %s", 'pass')
		...
		self.assertEqual(woeid.GetLastResponseCode(), 200)
		print("self.__api.GetPlacetypes(typ=35) %s", 'pass')
		...
		self.assertEqual(woeid.GetLastResponseCode(), 200)
		print("self.__api.GetPlacetype(typ=9,country='ES') %s", 'pass')
